<template>
  <section v-if="tmdbId" class="mt-6">
    ...
    <!-- Paginazione con template fornito -->
<div v-if="totalPages > 1" class="flex flex-col items-center">
  ...
  <div class="inline-flex mt-2 xs:mt-0">
    ...
    <button
      ...
      @click="page--; load()"
      class="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 rounded-s 
    ...
    <button
      ...
      @click="page++; load()"
      class="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 border-0 border-s border-gray-700 rounded-e 
             hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 
             dark:hover:bg-gray-700 dark:hover:text-white disabled:opacity-50 disabled:cursor-not-allowed"
    >
      &nbsp;
