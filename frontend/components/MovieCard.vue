...
<div class="w-full aspect-[2/3] overflow-hidden rounded relative group">
  ...
  >
    ...
    <div
      v-if="movie.overview"
      class="absolute inset-0 flex items-center justify-center px-3 text-left text-sm text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"
    >
      {{
  ...
  <div
    v-else
    class="w-full h-full flex items-center justify-center text-xs text-gray-500 bg-gray-100"
  >
    Nessun poster
  </div>
</div>
          ...
          <div class="bg-gray-50/80 backdrop-blur-sm px-6 py-4 space-y-3">
            ...
            <div>
              ...
              <textarea
                v-model="draft.note"
                rows="4"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-"
              >
Nota</label>
